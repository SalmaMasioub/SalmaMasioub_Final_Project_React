...
const About = () => {
    return (
        <div>
            <div className="bg-[url('/src/assets/images/contact_top.webp')] bg-cover bg-center h-[300px] flex items-center justify-center">
<h1 className='font-bold text-5xl text-amber-50'>ABOUT</h1>
            ...
            <div  className='flex flex-col sm:flex-row justify-between items-center gap-6 p-5 sm:p-8'>
                <img src={images.chemise} alt="" className=' w-100 p-8' />
