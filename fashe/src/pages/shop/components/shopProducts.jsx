...
const ShopProducts = () => {
    ...
    const handleColor = (color) => {
        setSelectedColors(prev => prev.includes(color) ? prev.filter(col => col !== color) : [...prev, color])
    }

    return (
        <div className="flex flex-col lg:flex-row">
            <div className="w-full lg:w-[25%] p-6">
                <div className="mb-6">
            ...
            <div className="w-full lg:w-[75%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-5 py-7">
