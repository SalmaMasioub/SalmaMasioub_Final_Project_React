...
import BlogSide from '../pages/home/components/blogside';
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row gap-10 px-6 py-10 max-w-7xl mx-auto">
      ...
      <div className="w-full lg:w-[75%]">
        ...
        <div className="flex gap-3 mb-9">
          ...
          <div>
            ...
            <p className="font-light text-gray-700">
              <span className="font-semibold text-gray-700">test name</span> / Jan 11, 2018 Reply
            </p>
        ...
        <p className="font-light text-gray-700 mb-11">
          Your email address will not be published. Required fields are marked * </p>

        <form action="" className='flex flex-col gap-3 items-start mb-20'>
          <textarea placeholder='Message' className="border border-gray-400 w-full h-35 p-4" />
          <input className="py-3 px-4 border border-gray-400 w-1/4" placeholder='Your Name' />
          <input className="py-3 px-4 border border-gray-400 w-1/4" placeholder='Email address' />
          <button type="button" className="mt-4 bg-gray-950 px-7 py-2 rounded-4xl text-white hover:bg-red-700">
            POST COMMENT
          </button>
          <p className="font-light text-gray-700 mb-11">
            Please note, comments must be approved before they are publishe.</p>
        </form>
      </div>
